...
depth_classes_reduced <- depth_classes[depth_classes >= min(my_seq) & depth_classes <= max(my_seq)]
...
restriction_h1 <- ggplot2::ggplot(restriction.df |>  dplyr::filter(restriction == "restrict_depth_h_in"), ggplot2::aes(x = value)) + ggplot2::geom_histogram(ggplot2::aes(text = paste("coiid(s):", coiid)), 
  ...
  ggplot2::scale_x_continuous(limits = c(min(my_seq), max(my_seq)),
                              breaks = my_seq[seq(1, length(my_seq), by = 2)]) + ggplot2::geom_vline(xintercept = depth_classes_reduced, colour="red")
...
restriction_h1 <- plotly::ggplotly(tooltip = c("text", "value")) |> plotly::layout(title = list(text = paste0('Restriction depth high',
                                    '<br>',
                                    '<sup>',
...
restriction_h2 <- plotly::ggplotly(tooltip = c("text", "value")) |> plotly::layout(title = list(text = paste0('Restriction depth high',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
restriction_l1 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Restriction depth low',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
restriction_l2 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Restriction depth low',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
restriction_r1 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Restriction depth representative',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
restriction_r2 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Restriction depth representative',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
soil_depth1 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Soil depth high',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
soil_depth2 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Soil depth high',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
soil_depth1 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Soil depth low',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
soil_depth2 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Soil depth low',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
soil_depth1 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Soil depth representative',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
...
soil_depth2 <- plotly::ggplotly(tooltip = c("text", "value")) |>  plotly::layout(title = list(text = paste0('Soil depth representative',
                                    '<br>',
                                    '<sup>',
                                    'Red line(s) represent depth class boundaries',
                                    '</sup>')))
