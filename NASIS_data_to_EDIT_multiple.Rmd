...
my_factor <- diff(range(c(EDIT_updates_filtered$elev_h_ft, 
             EDIT_updates_filtered$elev_l_ft)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$slope_h, 
             EDIT_updates_filtered$slope_l)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$pond_depth_h, 
             EDIT_updates_filtered$pond_depth_l)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$water_table_h_in, 
             EDIT_updates_filtered$water_table_l_in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$map_h_in, 
             EDIT_updates_filtered$map_l_in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$ffd_h, 
             EDIT_updates_filtered$ffd_l)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$frags_hi_gt_3in_on_surf, 
             EDIT_updates_filtered$frags_lo_gt_3in_on_surf)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$awc_h_0_40_in, 
             EDIT_updates_filtered$awc_l_0_40_in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$pH_h_0_10in, 
             EDIT_updates_filtered$pH_l_0_10in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$pH_h_10_40in, 
             EDIT_updates_filtered$pH_l_10_40in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in, 
             EDIT_updates_filtered$subsurf_frags_lo_2mm.3in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$sieve_subsurf_frags_hi_2mm.3in, 
             EDIT_updates_filtered$sieve_subsurf_frags_lo_2mm.3in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$subsurf_frags_hi_gt_3in, 
             EDIT_updates_filtered$subsurf_frags_lo_gt_3in)))/my_vector
...
my_factor <- diff(range(c(EDIT_updates_filtered$sieve_subsurf_frags_hi_gt_3in, 
             EDIT_updates_filtered$sieve_subsurf_frags_lo_gt_3in)))/my_vector
