...
```{r  class.source = "fold-show", echo=FALSE}
EDIT_updates_filtered <- EDIT_updates %>% filter(ecosite_id == "R022AA010CA")
```
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in, na.rm = TRUE) &
                   min(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres %>% filter(surf_frag == "surfhzn_frags_r_2mm.3in") %>% filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$surfhzn_frags_r_gt_3in, na.rm = TRUE) &
                   min(EDIT_updates_filtered$surfhzn_frags_r_gt_3in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$surfhzn_frags_r_gt_3in, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$surfhzn_frags_r_gt_3in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres %>% filter(surf_frag == "surfhzn_frags_r_gt_3in") %>% filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
