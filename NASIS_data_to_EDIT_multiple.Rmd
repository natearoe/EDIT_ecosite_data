...
el_h1 <- ggplot(elev.df |>  filter(elev == "elev_h_ft"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$elev_h_ft, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$elev_h_ft, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$elev_h_ft, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$elev_h_ft, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- elev.df.acres |>  filter(elev == "elev_h_ft") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(elev_h_acres_prepped$acres[elev_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
               ifelse(min(elev_h_acres_prepped$acres[elev_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_elev_h <- elev_h_acres_prepped[rep(1:nrow(elev_h_acres_prepped), times = elev_h_acres_prepped$acres/acreage_unit), c("range", "elev", "coiids"), drop = FALSE]
...
el_h2 <- ggplot(expand_elev_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Elevation (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Elevation (ft.)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$elev_l_ft, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$elev_h_ft, na.rm = TRUE),
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- elev.df.acres |>  filter(elev == "elev_l_ft") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(elev_l_acres_prepped$acres[elev_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(elev_l_acres_prepped$acres[elev_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_elev_l <- elev_l_acres_prepped[rep(1:nrow(elev_l_acres_prepped), times = elev_l_acres_prepped$acres/acreage_unit), c("range", "elev", "coiids"), drop = FALSE]
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- elev.df.acres |>  filter(elev == "elev_r_ft") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(elev_r_acres_prepped$acres[elev_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(elev_r_acres_prepped$acres[elev_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_elev_r <- elev_r_acres_prepped[rep(1:nrow(elev_r_acres_prepped), times = elev_r_acres_prepped$acres/acreage_unit), c("range", "elev", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$elev_r_ft))) {print("No data populated in NASIS for this field.")
  ...
  elev_r_stats_rep |>  quantile(c(0.05, 0.95), na.rm = TRUE)
...
Slope should be rounded to multiples of 5. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
slope_h1 <- ggplot(slope.df |>  filter(slope == "slope_h"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$slope_l, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$slope_h, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$slope_l, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$slope_h, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$slope_l, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$slope_h, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$slope_l, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$slope_h, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$slope_l, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$slope_l, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$slope_l, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- slope.df.acres |>  filter(slope == "slope_h") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(slope_h_acres_prepped$acres[slope_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(slope_h_acres_prepped$acres[slope_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_slope_h <- slope_h_acres_prepped[rep(1:nrow(slope_h_acres_prepped), times = slope_h_acres_prepped$acres/acreage_unit), c("range", "slope", "coiids"), drop = FALSE]
...
slope_h2 <- ggplot(expand_slope_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Slope (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Slope (%)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$slope_l, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$slope_h, na.rm = TRUE),
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- slope.df.acres |>  filter(slope == "slope_l") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(slope_l_acres_prepped$acres[slope_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(slope_l_acres_prepped$acres[slope_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_slope_l <- slope_l_acres_prepped[rep(1:nrow(slope_l_acres_prepped), times = slope_l_acres_prepped$acres/acreage_unit), c("range", "slope", "coiids"), drop = FALSE]
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$slope_h, na.rm = TRUE) &
             min(EDIT_updates_filtered$slope_h, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$slope_h, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$slope_h, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- slope.df.acres |>  filter(slope == "slope_r") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(slope_r_acres_prepped$acres[slope_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(slope_r_acres_prepped$acres[slope_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_slope_r <- slope_r_acres_prepped[rep(1:nrow(slope_r_acres_prepped), times = slope_r_acres_prepped$acres/acreage_unit), c("range", "slope", "coiids"), drop = FALSE]
...
One thing to clarify about ponding depth - this is a measure of how deep the ponding is above the soil surface. 

If ecosite does not have a ponding depth, enter "NA"

Ponding depth should be rounded appropriate to the data. For ecosites that experience considerable ponding, rounding to multiples of five may be appropriate. Otherwise, rounding to multiples of two or not rounding may be appropriate. 
...
pond_depth.df <-
  EDIT_updates_filtered |>  select(coiid, pond_depth_l, pond_depth_h, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "pond_depth",
    values_to = "value",
...
pond_depth_h1 <- ggplot(pond_depth.df |>  filter(pond_depth == "pond_depth_h"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Ponding depth (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Ponding depth (inches)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE), round_by, f = ceiling), round_by))))

# Convert histogram to plotly

pond_depth_h1 <- ggplotly(pond_depth_h1, tooltip = "text")

# Manipulate to create acreage histogram

my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE) &
             min(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
pond_depth.df.acres <- pond_depth.df
pond_depth.df.acres$value <- ifelse(pond_depth.df.acres$value == 0, pond_depth.df.acres$value + 0.1, pond_depth.df.acres$value)

for(i in names(my_seq)){
  
  if(i == 0){
      
  my_list[[i]] <- pond_depth.df.acres |>  filter(pond_depth == "pond_depth_h") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
my_list_summarised <- lapply(my_list, FUN = function(x){
  x |>  dplyr::mutate(value = as.numeric(value)) |>  group_by(pond_depth) |>  summarise(range = mean(value), acres = sum(acres), coiids = toString(coiid)) |>  ungroup()
})

pond_depth_h_acres <- do.call(rbind, my_list_summarised)

pond_depth_h_acres$numb_coiids <- sapply(pond_depth_h_acres$coiids, FUN = function(x){
      x |>  unlist() |>  strsplit(",") |>  unlist() |>  length()
})


pond_depth_h_acres_na <- pond_depth.df.acres |>  dplyr::filter(is.na(value)) |>  summarise(acres = sum(acres), 
                          coiids = n()) |>  cbind(range = NA, pond_depth = NA)


pond_depth_h_acres_prepped <- data.frame(pond_depth = my_seq, row.names = NULL) |>  dplyr::rename(range = pond_depth) |> 
                        dplyr::left_join(pond_depth_h_acres)

pond_depth_na_h <- rbind(pond_depth_h_acres_prepped |>  select(-coiids) |>  dplyr::rename(coiids = numb_coiids), pond_depth_h_acres_na)

pond_depth_h_acres_prepped$acres <- ifelse(is.na(pond_depth_h_acres_prepped$acres), 0, pond_depth_h_acres_prepped$acres)
pond_depth_h_acres_prepped$range <- pond_depth_h_acres_prepped$range + 0.1

acreage_unit <- ifelse(min(pond_depth_h_acres_prepped$acres[pond_depth_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(pond_depth_h_acres_prepped$acres[pond_depth_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_pond_depth_h <- pond_depth_h_acres_prepped[rep(1:nrow(pond_depth_h_acres_prepped), times = pond_depth_h_acres_prepped$acres/acreage_unit), c("range", "pond_depth", "coiids"), drop = FALSE]

# Create acreage histogram

pond_depth_h2 <- ggplot(expand_pond_depth_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Ponding depth (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Ponding depth (inches)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$pond_depth_h, na.rm = TRUE),
...
pond_depth_h2 <- ggplotly(pond_depth_h2, tooltip = "text")
...
NAs in ponding depth likely mean that no ponding was observed. NA's are not represented in the figures above. Please observe the table below to understand the relative acreage classified as NA. 
```{r}
if (all(is.na(EDIT_updates_filtered$pond_depth_h))) {print("No data populated in NASIS for this field.")
...
if (all(is.na(EDIT_updates_filtered$pond_depth_h))) {print("No data populated in NASIS for this field.")
  ...
  pond_depth_na_h_rem <- pond_depth_na_h |>  dplyr::filter(!is.na(acres)) |> 
        arrange(!is.na(pond_depth), pond_depth)
  pond_depth_na_h_rem_expanded <- rep(pond_depth_na_h_rem$range, pond_depth_na_h_rem$acres)
  
  data.frame("95%" = pond_depth_na_h_rem_expanded[ceiling(0.95 * length(pond_depth_na_h_rem_expanded))], check.names = FALSE)
...
**Ponding depth high acreage weighted summary statistics**
```{r}
...
if (all(is.na(EDIT_updates_filtered$pond_depth_h))) {print("No data populated in NASIS for this field. For ponding, this likely means no ponding was observed.")
  ...
  pond_depth_h_stats <- pond_depth.df |>  dplyr::filter(pond_depth == "pond_depth_h")
  pond_depth_h_stats_rep <- rep(pond_depth_h_stats$value, pond_depth_h_stats$acres) 
  summary(pond_depth_h_stats_rep)
...
pond_depth_l1 <- ggplot(pond_depth.df |>  filter(pond_depth == "pond_depth_l"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Ponding depth (low)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Ponding depth (inches)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE),
             round_by,
             f = floor) ==
...
pond_depth_l1 <- ggplotly(pond_depth_l1, tooltip = "text")
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- pond_depth.df.acres |>  filter(pond_depth == "pond_depth_l") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
pond_depth_l_acres <- do.call(rbind, my_list_summarised)


pond_depth_l_acres$numb_coiids <- sapply(pond_depth_l_acres$coiids, FUN = function(x){
      x |>  unlist() |>  strsplit(",") |>  unlist() |>  length()
})


pond_depth_l_acres_na <- pond_depth.df.acres |>  dplyr::filter(is.na(value)) |>  summarise(acres = sum(acres), 
                          coiids = n()) |>  cbind(range = NA, pond_depth = NA)


pond_depth_l_acres_prepped <- data.frame(pond_depth = my_seq, row.names = NULL) |>  dplyr::rename(range = pond_depth) |> 
                        dplyr::left_join(pond_depth_l_acres)

pond_depth_na_l <- rbind(pond_depth_l_acres_prepped |>  select(-coiids) |>  dplyr::rename(coiids = numb_coiids), pond_depth_l_acres_na)

pond_depth_l_acres_prepped$acres <- ifelse(is.na(pond_depth_l_acres_prepped$acres), 0, pond_depth_l_acres_prepped$acres)
pond_depth_l_acres_prepped$range <- pond_depth_l_acres_prepped$range + 0.1

acreage_unit <- ifelse(min(pond_depth_l_acres_prepped$acres[pond_depth_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(pond_depth_l_acres_prepped$acres[pond_depth_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_pond_depth <- pond_depth_l_acres_prepped[rep(1:nrow(pond_depth_l_acres_prepped), times = pond_depth_l_acres_prepped$acres/acreage_unit), c("range", "pond_depth", "coiids"), drop = FALSE]

# Create acreage histogram

pond_depth_l2 <- ggplot(expand_pond_depth, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
...
pond_depth_l2 <- ggplotly(pond_depth_l2, tooltip = "text")
...
NA's in ponding depth likely mean that no ponding was observed. NA's are not represented in the figures above. Please observe the table below to understand the relative acreage classified as NA. 
```{r}
if (all(is.na(EDIT_updates_filtered$pond_depth_l))) {print("No data populated in NASIS for this field.")
...
if (all(is.na(EDIT_updates_filtered$pond_depth_l))) {print("No data populated in NASIS for this field.")
  ...
  pond_depth_na_l_rem <- pond_depth_na_l |>  dplyr::filter(!is.na(acres)) |> 
        arrange(!is.na(pond_depth), pond_depth)
  pond_depth_na_l_rem_expanded <- rep(pond_depth_na_l_rem$range, pond_depth_na_l_rem$acres)
  
  data.frame("5%" = pond_depth_na_l_rem_expanded[ceiling(0.05 * length(pond_depth_na_l_rem_expanded))], check.names = FALSE)
  
}

```

**Ponding depth low acreage weighted summary statistics**
```{r}
...
if (all(is.na(EDIT_updates_filtered$pond_depth_l))) {print("No data populated in NASIS for this field. For ponding, this likely means no ponding was observed.")
 ...
 pond_depth_l_stats <- pond_depth.df |>  dplyr::filter(pond_depth == "pond_depth_l")
 pond_depth_l_stats_rep <- rep(pond_depth_l_stats$value,pond_depth_l_stats$acres) 
  summary(pond_depth_l_stats_rep)
...
if (all(is.na(EDIT_updates_filtered$pond_depth_rv))) {print("No data populated in NASIS for this field.")
...
pond_depth.df <-
  EDIT_updates_filtered |>  select(coiid, pond_depth_h, pond_depth_l, pond_depth_rv, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "pond_depth",
    values_to = "value",
    cols = c("pond_depth_h", "pond_depth_l", "pond_depth_rv")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

pond_depth_rv1 <- ggplot(pond_depth.df |>  filter(pond_depth == "pond_depth_rv"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Ponding depth (RV)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Ponding depth (inches)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE),
             round_by,
             f = floor) ==
...
pond_depth_rv1 <- ggplotly(pond_depth_rv1, tooltip = "text")
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- pond_depth.df.acres |>  filter(pond_depth == "pond_depth_rv") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
pond_depth_rv_acres <- do.call(rbind, my_list_summarised)


pond_depth_rv_acres$numb_coiids <- sapply(pond_depth_rv_acres$coiids, FUN = function(x){
    x |>  unlist() |>  strsplit(",") |>  unlist() |>  length()
  })
  
  
  pond_depth_rv_acres_na <- pond_depth.df.acres |>  dplyr::filter(is.na(value)) |>  summarise(acres = sum(acres), 
                                                                                             coiids = n()) |>  cbind(range = NA, pond_depth = NA)
  
  
  pond_depth_rv_acres_prepped <- data.frame(pond_depth = my_seq, row.names = NULL) |>  dplyr::rename(range = pond_depth) |> 
    dplyr::left_join(pond_depth_rv_acres)
  
  pond_depth_na_rv <- rbind(pond_depth_rv_acres_prepped |>  select(-coiids) |>  dplyr::rename(coiids = numb_coiids), pond_depth_rv_acres_na)
  
  pond_depth_rv_acres_prepped$acres <- ifelse(is.na(pond_depth_rv_acres_prepped$acres), 0, pond_depth_rv_acres_prepped$acres)
  pond_depth_rv_acres_prepped$range <- pond_depth_rv_acres_prepped$range + 0.1
  
  acreage_unit <- ifelse(min(pond_depth_rv_acres_prepped$acres[pond_depth_rv_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                         ifelse(min(pond_depth_rv_acres_prepped$acres[pond_depth_rv_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))
  
  names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))
  
  expand_pond_depth_rv <- pond_depth_rv_acres_prepped[rep(1:nrow(pond_depth_rv_acres_prepped), times = pond_depth_rv_acres_prepped$acres/acreage_unit), c("range", "pond_depth", "coiids"), drop = FALSE]
  


# Create acreage histogram

pond_depth_rv2 <- ggplot(expand_pond_depth_rv, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pond_depth_l, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
...
pond_depth_rv2 <- ggplotly(pond_depth_rv2, tooltip = "text")

# Join both figures

manipulateWidget::combineWidgets(pond_depth_rv1,
                                 pond_depth_rv2,
                                 nrow = 1,
                                 ncol = 2,
                                 colsize = c(1, 1))
...
**Ponding depth RV acreage weighted 5th percentile** -  use as 'low (actual)'. This value may be NA.  
...
if (all(is.na(EDIT_updates_filtered$pond_depth_rv))) {print("No data populated in NASIS for this field.")
  ...
  pond_depth_na_rv_rem <- pond_depth_na_rv |>  dplyr::filter(!is.na(acres)) |> 
        arrange(!is.na(pond_depth), pond_depth)
  pond_depth_na_rv_rem_expanded <- rep(pond_depth_na_rv_rem$range, pond_depth_na_rv_rem$acres)
  
  data.frame("5%" = pond_depth_na_rv_rem_expanded[ceiling(0.05 * length(pond_depth_na_rv_rem_expanded))], check.names = FALSE)
  
}

```

**Ponding depth RV acreage weighted summary statistics**
```{r}

if (all(is.na(EDIT_updates_filtered$pond_depth_rv))) {print("No data populated in NASIS for this field. For ponding, this likely means no ponding was observed.")
  
} else{
  

 pond_depth_rv_stats <- pond_depth.df |>  dplyr::filter(pond_depth == "pond_depth_rv")
 pond_depth_rv_stats_rep <- rep(pond_depth_rv_stats$value,pond_depth_rv_stats$acres) 
  summary(pond_depth_rv_stats_rep)
...
Water table depth should be rounded appropriate to the data. For many situations, rounding to multiples of five works well. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
water_table_h1 <- ggplot(water_table.df |>  filter(water_table == "water_table_h_in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE),
                                           round_by,
                                           f = floor) ==
                                 round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE),
                                           round_by,
                                           f = ceiling)) {
    c(round_any(
      min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE),
      round_by,
      f = floor
    ),
    round_any(
    ...
    round_any(
      max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE),
      round_by,
      f = ceiling
    ))
  },
   n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor),
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE) &
             min(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- water_table.df.acres |>  filter(water_table == "water_table_h_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(water_table_h_acres_prepped$acres[water_table_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(water_table_h_acres_prepped$acres[water_table_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_water_table_h <- water_table_h_acres_prepped[rep(1:nrow(water_table_h_acres_prepped), times = water_table_h_acres_prepped$acres/acreage_unit), c("range", "water_table", "coiids"), drop = FALSE]
...
water_table_h2 <- ggplot(expand_water_table_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Water table (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Water table (inches)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE),
  ...
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- water_table.df.acres |>  filter(water_table == "water_table_l_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(water_table_l_acres_prepped$acres[water_table_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(water_table_l_acres_prepped$acres[water_table_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_water_table <- water_table_l_acres_prepped[rep(1:nrow(water_table_l_acres_prepped), times = water_table_l_acres_prepped$acres/acreage_unit), c("range", "water_table", "coiids"), drop = FALSE]
...
I’m not aware of specific guidance on populating aspect data in EDIT. I personally would choose the aspects that you feel are representative. That would mean trimming values that don’t seem like a core part of the distribution/concept. I am fairly liberal in saying that aspect is ‘not applicable’ if I don’t think I have the data to make a meaningful call. If there are only 2-3 components correlated to the ecosite, I would consider it pretty challenging to make a strong call unless they are tightly clustered. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$aspect_rep, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$aspect_rep, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$aspect_rep, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- aspect.df.acres |>  filter(aspect == "aspect_rep") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(aspect_r_acres_prepped$acres[aspect_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(aspect_r_acres_prepped$acres[aspect_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_aspect_r <- aspect_r_acres_prepped[rep(1:nrow(aspect_r_acres_prepped), times = aspect_r_acres_prepped$acres/acreage_unit), c("range", "aspect", "coiids"), drop = FALSE]
...
aspect_r2 <- ggplot(expand_aspect_r, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Aspect") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Aspect (degrees)") +
  scale_x_continuous(limits = c(0, 360),
  breaks = seq(0,360, 30))
...
Mean annual precip. should be rounded appropriate to the data. For many situations, rounding to multiples of five works well. 
```{r, warning=FALSE, message=FALSE}
# Is variable NA?
...
map_h1 <- ggplot(map.df |>  filter(map == "map_h_in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$map_l_in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$map_h_in, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$map_l_in, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$map_h_in, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$map_l_in, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$map_h_in, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$map_l_in, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$map_h_in, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$map_l_in, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$map_l_in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$map_l_in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- map.df.acres |>  filter(map == "map_h_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(map_h_acres_prepped$acres[map_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(map_h_acres_prepped$acres[map_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_map_h <- map_h_acres_prepped[rep(1:nrow(map_h_acres_prepped), times = map_h_acres_prepped$acres/acreage_unit), c("range", "map", "coiids"), drop = FALSE]
...
map_h2 <- ggplot(expand_map_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Mean Annual Precip. (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Mean annual precip. (in.)") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$map_l_in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$map_h_in, na.rm = TRUE),
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- map.df.acres |>  filter(map == "map_l_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(map_l_acres_prepped$acres[map_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(map_l_acres_prepped$acres[map_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_map_l <- map_l_acres_prepped[rep(1:nrow(map_l_acres_prepped), times = map_l_acres_prepped$acres/acreage_unit), c("range", "map", "coiids"), drop = FALSE]
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- map.df.acres |>  filter(map == "map_r_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(map_r_acres_prepped$acres[map_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(map_r_acres_prepped$acres[map_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_map_r <- map_r_acres_prepped[rep(1:nrow(map_r_acres_prepped), times = map_r_acres_prepped$acres/acreage_unit), c("range", "map", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$map_r_in))) {print("No data populated in NASIS for this field.")
  ...
  map_r_stats_rep |>  quantile(c(0.05, 0.95), na.rm = TRUE)
...
Frost free days should be rounded appropriate to the data. For many situations, rounding to multiples of five works well. 
```{r, warning=FALSE, message=FALSE}
# Is variable NA?
...
ffd_h1 <- ggplot(ffd.df |>  filter(ffd == "ffd_h"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$ffd_l, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$ffd_h, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$ffd_l, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$ffd_h, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$ffd_l, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$ffd_h, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$ffd_l, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$ffd_h, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$ffd_l, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$ffd_l, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$ffd_l, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  my_list[[i]] <- ffd.df.acres |>  filter(ffd == "ffd_h") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(ffd_h_acres_prepped$acres[ffd_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(ffd_h_acres_prepped$acres[ffd_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_ffd_h <- ffd_h_acres_prepped[rep(1:nrow(ffd_h_acres_prepped), times = ffd_h_acres_prepped$acres/acreage_unit), c("range", "ffd", "coiids"), drop = FALSE]
...
ffd_h2 <- ggplot(expand_ffd_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Frost Free Days (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Frost Free Days") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$ffd_l, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$ffd_h, na.rm = TRUE),
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$ffd_h, na.rm = TRUE) &
             min(EDIT_updates_filtered$ffd_h, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$ffd_h, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$ffd_h, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
 ...
 if(i == 0){
    ...
    my_list[[i]] <- ffd.df.acres |>  filter(ffd == "ffd_l") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(ffd_l_acres_prepped$acres[ffd_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(ffd_l_acres_prepped$acres[ffd_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_ffd_l <- ffd_l_acres_prepped[rep(1:nrow(ffd_l_acres_prepped), times = ffd_l_acres_prepped$acres/acreage_unit), c("range", "ffd", "coiids"), drop = FALSE]
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- ffd.df.acres |>  filter(ffd == "ffd_r") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(ffd_r_acres_prepped$acres[ffd_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(ffd_r_acres_prepped$acres[ffd_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_ffd_r <- ffd_r_acres_prepped[rep(1:nrow(ffd_r_acres_prepped), times = ffd_r_acres_prepped$acres/acreage_unit), c("range", "ffd", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$ffd_r))) {print("No data populated in NASIS for this field.")
  ...
  ffd_r_stats_rep |>  quantile(c(0.05, 0.95), na.rm = TRUE)
...
Depth to restriction should be rounded appropriate to the data. For many situations, rounding to multiples of five works well. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- restriction.df.acres |>  filter(restriction == "restrict_depth_h_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(restriction_h_acres_prepped$acres[restriction_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(restriction_h_acres_prepped$acres[restriction_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_restriction_h <- restriction_h_acres_prepped[rep(1:nrow(restriction_h_acres_prepped), times = restriction_h_acres_prepped$acres/acreage_unit), c("range", "restriction", "coiids"), drop = FALSE]
...
restriction_h2 <- ggplot(expand_restriction_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Restriction depth (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Restriction depth (in.)") +
  scale_x_continuous(limits = c(0, 90),
  breaks = seq(0, 90, 5))
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- restriction.df.acres |>  filter(restriction == "restrict_depth_l_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(restriction_l_acres_prepped$acres[restriction_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(restriction_l_acres_prepped$acres[restriction_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_restriction_l <- restriction_l_acres_prepped[rep(1:nrow(restriction_l_acres_prepped), times = restriction_l_acres_prepped$acres/acreage_unit), c("range", "restriction", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$restrict_depth_r_in))) {print("No data populated in NASIS for this field. Enter NA for low & high (representative).")
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- restriction.df.acres |>  filter(restriction == "restrict_depth_r_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(restriction_r_acres_prepped$acres[restriction_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(restriction_r_acres_prepped$acres[restriction_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_restriction_r <- restriction_r_acres_prepped[rep(1:nrow(restriction_r_acres_prepped), times = restriction_r_acres_prepped$acres/acreage_unit), c("range", "restriction", "coiids"), drop = FALSE]
...
} else{restriction_na_r}
```




**Restriction RV acreage weighted 5th and 95th percentile** -  use as 'low (representative)' and 'high (representative)'. These values may be NA.  
...
#### **Surface frag high percent cover (2 mm - 3 in.) **

Surface frag percent cover should be rounded appropriate to the data. For many situations, rounding to multiples of five works well. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
EDIT_updates_filtered$frags_r_2mm_3in_on_surf <- ifelse(is.na(EDIT_updates_filtered$frags_r_2mm_3in_on_surf), 0, EDIT_updates_filtered$frags_r_2mm_3in_on_surf)
...
surf_frag.df <-
  EDIT_updates_filtered |>  select(coiid, frags_hi_2mm_3in_on_surf, frags_lo_2mm_3in_on_surf,
                                   frags_r_2mm_3in_on_surf, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "surf_frag",
    values_to = "value",
    cols = c("frags_hi_2mm_3in_on_surf", "frags_lo_2mm_3in_on_surf", "frags_r_2mm_3in_on_surf")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_hi_2mm_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frag 2mm - 3inches (high)") + theme(plot.title = element_text(hjust = 0.5)) +
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$frags_hi_2mm_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$frags_hi_2mm_3in_on_surf, na.rm = TRUE) &
                   min(EDIT_updates_filtered$frags_hi_2mm_3in_on_surf, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$frags_hi_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$frags_hi_2mm_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres |>  filter(surf_frag == "frags_hi_2mm_3in_on_surf") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(surf_frag_r_acres_prepped$acres[surf_frag_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(surf_frag_r_acres_prepped$acres[surf_frag_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_surf_frag <- surf_frag_r_acres_prepped[rep(1:nrow(surf_frag_r_acres_prepped), times = surf_frag_r_acres_prepped$acres/acreage_unit), c("range", "surf_frag", "coiids"), drop = FALSE]
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frags 2mm - 3inches (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Surface frags high 2 mm - 3 in. acreage weighted 95th percentile**
...
if (all(is.na(EDIT_updates_filtered$frags_hi_2mm_3in_on_surf))) {print("No data populated in NASIS for this field.")
  ...
  surf_frag_h_stats <- surf_frag.df |>  dplyr::filter(surf_frag == "frags_hi_2mm_3in_on_surf")
  surf_frag_h_stats_rep <- rep(surf_frag_h_stats$value, surf_frag_h_stats$acres) 
  surf_frag_h_stats_rep |>  quantile(probs = c(0.95), na.rm = TRUE)
...
**Surface frags high 2 mm - 3 in. percentage acreage weighted summary statistics**
```{r}
...
#### **Surface frag low percent cover (2 mm - 3 in.) **
...
surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_lo_2mm_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frag 2mm - 3inches (low)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Surface frag (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres |>  filter(surf_frag == "frags_lo_2mm_3in_on_surf") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frags 2mm - 3inches (low)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Surface frags low 2 mm - 3 in. acreage weighted 5th percentile**
...
if (all(is.na(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf))) {print("No data populated in NASIS for this field.")
  ...
  surf_frag_h_stats <- surf_frag.df |>  dplyr::filter(surf_frag == "frags_lo_2mm_3in_on_surf")
  surf_frag_h_stats_rep <- rep(surf_frag_h_stats$value, surf_frag_h_stats$acres) 
  surf_frag_h_stats_rep |>  quantile(probs = c(0.05), na.rm = TRUE)

}

```

**Surface frags low 2 mm - 3 in. percentage acreage weighted summary statistics**
...
#### **Surface frag RV percent cover (2 mm - 3 in.) **
...
surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_r_2mm_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_lo_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frag 2mm - 3inches (RV)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Surface frag (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$frags_r_2mm_3in_on_surf, na.rm = TRUE) &
                   min(EDIT_updates_filtered$frags_r_2mm_3in_on_surf, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$frags_r_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$frags_r_2mm_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres |>  filter(surf_frag == "frags_r_2mm_3in_on_surf") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frags 2mm - 3inches (RV)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Surface frags RV 2 mm - 3 in. acreage weighted 5th and 95th percentiles**


use as 'low (representative)' and 'high (representative)' 
```{r, fig.show="hold", out.width="50%"}
if (all(is.na(EDIT_updates_filtered$frags_r_2mm_3in_on_surf))) {print("No data populated in NASIS for this field.")
  
} else{
  
  surf_frag_h_stats <- surf_frag.df |>  dplyr::filter(surf_frag == "frags_r_2mm_3in_on_surf")
  surf_frag_h_stats_rep <- rep(surf_frag_h_stats$value, surf_frag_h_stats$acres) 
  surf_frag_h_stats_rep |>  quantile(probs = c(0.05, 0.95), na.rm = TRUE)
...
#### **Surface frag high percent cover (3 in. +)** 
...
EDIT_updates_filtered$frags_r_gt_3in_on_surf <- ifelse(is.na(EDIT_updates_filtered$frags_r_gt_3in_on_surf), 0, EDIT_updates_filtered$frags_r_gt_3in_on_surf)
...
surf_frag.df <-
  EDIT_updates_filtered |>  select(coiid, frags_r_gt_3in_on_surf, frags_lo_gt_3in_on_surf,
                                   frags_hi_gt_3in_on_surf, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "surf_frag",
    values_to = "value",
    cols = c("frags_r_gt_3in_on_surf", "frags_lo_gt_3in_on_surf", "frags_hi_gt_3in_on_surf")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_hi_gt_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frag high 3 inches +") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Surface frag (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$frags_hi_gt_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$frags_hi_gt_3in_on_surf, na.rm = TRUE) &
                   min(EDIT_updates_filtered$frags_hi_gt_3in_on_surf, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$frags_hi_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$frags_hi_gt_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres |>  filter(surf_frag == "frags_hi_gt_3in_on_surf") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frags 3 inches + (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Surface frags high percent cover 3 in. + acreage weighted 5th percentile**
...
if (all(is.na(EDIT_updates_filtered$frags_hi_gt_3in_on_surf))) {print("No data populated in NASIS for this field.")
  ...
  surf_frag_h_stats <- surf_frag.df |>  dplyr::filter(surf_frag == "frags_hi_gt_3in_on_surf")
  surf_frag_h_stats_rep <- rep(surf_frag_h_stats$value, surf_frag_h_stats$acres) 
  surf_frag_h_stats_rep |>  quantile(probs = c(0.95), na.rm = TRUE)
...
**Surface frags high 3 in. + percentage acreage weighted summary statistics**
...
#### **Surface frag low percent cover (3 in. +)** 
...
surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_lo_gt_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frag low (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Surface frag (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres |>  filter(surf_frag == "frags_lo_gt_3in_on_surf") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frags low (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Surface frags low percent cover (3 in. +) acreage weighted 5th percentile**
...
if (all(is.na(EDIT_updates_filtered$frags_lo_gt_3in_on_surf))) {print("No data populated in NASIS for this field.")
  ...
  surf_frag_h_stats <- surf_frag.df |>  dplyr::filter(surf_frag == "frags_lo_gt_3in_on_surf")
  surf_frag_h_stats_rep <- rep(surf_frag_h_stats$value, surf_frag_h_stats$acres) 
  surf_frag_h_stats_rep |>  quantile(probs = c(0.05), na.rm = TRUE)
...
**Surface frags low (3 in.+) percentage acreage weighted summary statistics**
...
#### **Surface frag RV percent cover (3 in. +)** 
...
surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_r_gt_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_lo_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frag RV (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Surface frag (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$frags_r_gt_3in_on_surf, na.rm = TRUE) &
                   min(EDIT_updates_filtered$frags_r_gt_3in_on_surf, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$frags_r_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) - bin_width,
  round_any(max(EDIT_updates_filtered$frags_r_gt_3in_on_surf, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
         my_seq            
                  }
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- surf_frag.df.acres |>  filter(surf_frag == "frags_r_gt_3in_on_surf") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Surface frags RV (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Surface frags RV percent cover (3 in. +) acreage weighted 5th and 95th percentiles**
...
if (all(is.na(EDIT_updates_filtered$frags_r_gt_3in_on_surf))) {print("No data populated in NASIS for this field.")
  ...
  surf_frag_h_stats <- surf_frag.df |>  dplyr::filter(surf_frag == "frags_r_gt_3in_on_surf")
  surf_frag_h_stats_rep <- rep(surf_frag_h_stats$value, surf_frag_h_stats$acres) 
  surf_frag_h_stats_rep |>  quantile(probs = c(0.05, 0.95), na.rm = TRUE)
...
**Surface frags RV (3 in.+) percentage acreage weighted summary statistics**
...
AWC should be rounded appropriate to the data. For many situations, rounding to multiples of five works well. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
awc_h1 <- ggplot(awc_h.df |>  filter(awc == "awc_h_0_40_in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE) &
             min(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- awc_h.df.acres |>  filter(awc == "awc_h_0_40_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(awc_h_acres_prepped$acres[awc_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(awc_h_acres_prepped$acres[awc_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_awc_h <- awc_h_acres_prepped[rep(1:nrow(awc_h_acres_prepped), times = awc_h_acres_prepped$acres/acreage_unit), c("range", "awc", "coiids"), drop = FALSE]
...
awc_h2 <- ggplot(expand_awc_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("AWC") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$awc_h_0_40_in, na.rm = TRUE),
...
awc_l1 <- ggplot(awc_l.df |>  filter(awc == "awc_l_0_40_in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("AWC 0-40inches (low)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("AWC") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE),
             round_by,
             f = floor) ==
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- awc_l.df.acres |>  filter(awc == "awc_l_0_40_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(awc_l_acres_prepped$acres[awc_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(awc_l_acres_prepped$acres[awc_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_awc_l <- awc_l_acres_prepped[rep(1:nrow(awc_l_acres_prepped), times = awc_l_acres_prepped$acres/acreage_unit), c("range", "awc", "coiids"), drop = FALSE]
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$awc_l_0_40_in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- awc_r.df.acres |>  filter(awc == "awc_r_0_40_in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(awc_r_acres_prepped$acres[awc_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(awc_r_acres_prepped$acres[awc_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_awc_r <- awc_r_acres_prepped[rep(1:nrow(awc_r_acres_prepped), times = awc_r_acres_prepped$acres/acreage_unit), c("range", "awc", "coiids"), drop = FALSE]
...
Given the log scale of pH, it is best not to round values. 
```{r message=FALSE, warning=FALSE}
# Is variable NA?
...
ph_h1 <- ggplot(ph_h.df |>  filter(ph == "pH_h_0_10in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pH_l_0_10in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$pH_l_0_10in, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$pH_l_0_10in, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$pH_l_0_10in, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE) &
             min(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- ph_h.df.acres |>  filter(ph == "pH_h_0_10in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(ph_h_acres_prepped$acres[ph_h_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(ph_h_acres_prepped$acres[ph_h_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_ph_h <- ph_h_acres_prepped[rep(1:nrow(ph_h_acres_prepped), times = ph_h_acres_prepped$acres/acreage_unit), c("range", "ph", "coiids"), drop = FALSE]
...
ph_h2 <- ggplot(expand_ph_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("pH 0-10 inches (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("pH") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pH_l_0_10in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$pH_h_0_10in, na.rm = TRUE),
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- ph_l.df.acres |>  filter(ph == "pH_l_0_10in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(ph_l_acres_prepped$acres[ph_l_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(ph_l_acres_prepped$acres[ph_l_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_ph_l <- ph_l_acres_prepped[rep(1:nrow(ph_l_acres_prepped), times = ph_l_acres_prepped$acres/acreage_unit), c("range", "ph", "coiids"), drop = FALSE]
...
ph_h1 <- ggplot(ph_h.df |>  filter(ph == "pH_h_10_40in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)),
  ...
  ylab("# of components") + xlab("pH") +
  scale_x_continuous(limits = if(round_any(min(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE),
             round_by,
             f = floor) ==
   round_any(max(EDIT_updates_filtered$pH_h_10_40in, na.rm = TRUE),
             round_by,
             f = ceiling)) {
  c(round_any(
    min(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE),
    round_by,
    f = floor
  ),
  round_any(
  ...
  round_any(
    max(EDIT_updates_filtered$pH_h_10_40in, na.rm = TRUE),
    round_by,
    f = ceiling
  ))
},
  n.breaks = ifelse(length(seq(round_any(min(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE), round_by, f = floor),
                  round_any(max(EDIT_updates_filtered$pH_h_10_40in, na.rm = TRUE), round_by, f = ceiling), round_by)) == 1, 2, length(seq(round_any(min(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE), round_by, f = floor),                                              round_any(max(EDIT_updates_filtered$pH_h_10_40in, na.rm = TRUE), round_by, f = ceiling), round_by))))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$pH_l_10_40in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- ph_h.df.acres |>  filter(ph == "pH_h_10_40in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- ph_l.df.acres |>  filter(ph == "pH_l_10_40in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
#### **Subsurface frag high percent (2 mm - 3 in.)**
...
EDIT_updates_filtered$subsurf_frags_r_2mm.3in <- ifelse(is.na(EDIT_updates_filtered$subsurf_frags_r_2mm.3in), 0, EDIT_updates_filtered$subsurf_frags_r_2mm.3in)
...
subsurf_frags_small.df <-
  EDIT_updates_filtered |>  select(coiid, subsurf_frags_r_2mm.3in, 
                                   subsurf_frags_hi_2mm.3in, subsurf_frags_lo_2mm.3in, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "frag_small",
    values_to = "value",
    cols = c("subsurf_frags_r_2mm.3in", "subsurf_frags_hi_2mm.3in", "subsurf_frags_lo_2mm.3in")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_hi_2mm.3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Subsurface frags high (2mm - 3 inches)") + theme(plot.title = element_text(hjust = 0.5)) +
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in, na.rm = TRUE) &
             min(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_hi_2mm.3in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
acreage_unit <- ifelse(min(subsurf_frags_r_acres_prepped$acres[subsurf_frags_r_acres_prepped$acres != 0], na.rm = TRUE) < 100, 10, 
                       ifelse(min(subsurf_frags_r_acres_prepped$acres[subsurf_frags_r_acres_prepped$acres != 0], na.rm = TRUE) < 1000, 100, 1000))

names(acreage_unit) <- ifelse(acreage_unit == 10, "tens", ifelse(acreage_unit == 100, "hundreds", "thousands"))

expand_subsurf_frags_r <- subsurf_frags_r_acres_prepped[rep(1:nrow(subsurf_frags_r_acres_prepped), times = subsurf_frags_r_acres_prepped$acres/acreage_unit), c("range", "frag_small", "coiids"), drop = FALSE]
...
subsurf_frags_small_r2 <- ggplot(expand_subsurf_frags_r, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Subsurface frags high (2mm - 3 inches)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab(paste0("acres (", names(acreage_unit), " of acres)")) + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
**Subsurface frags high 2 mm - 3 in. acreage weighted 95th percentile**
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_hi_2mm.3in))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats <- subsurf_frags_small.df |>  dplyr::filter(frag_small == "subsurf_frags_hi_2mm.3in" & ! is.na(value))
  subsurf_stats_rep <- rep(subsurf_stats$value, subsurf_stats$acres)
  subsurf_stats_rep |>  quantile(probs = c(0.95), na.rm = TRUE)
...
**Subsurface frags high 2 mm - 3 in. percentage acreage weighted summary statistics**
```{r}
...
#### **Subsurface frag low percent (2 mm - 3 in.)**
...
subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_lo_2mm.3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Subsurface frags low (2mm - 3 inches)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_lo_2mm.3in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
**Subsurface frags low 2 mm - 3 in. acreage weighted 5th percentile**
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_lo_2mm.3in))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats <- subsurf_frags_small.df |>  dplyr::filter(frag_small == "subsurf_frags_lo_2mm.3in" & ! is.na(value))
  subsurf_stats_rep <- rep(subsurf_stats$value, subsurf_stats$acres)
  subsurf_stats_rep |>  quantile(probs = c(0.05), na.rm = TRUE)
...
**Subsurface frags low (2 mm - 3 in.) percentage acreage weighted summary statistics**
```{r}
...
#### **Subsurface frag RV percent (2 mm - 3 in.)**
...
subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_r_2mm.3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Subsurface frags RV (2mm - 3 inches)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in, na.rm = TRUE) &
             min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in, na.rm = TRUE), round_by, f = floor) - bin_width,
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_r_2mm.3in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
**Subsurface frag percentage RV acreage weighted 5th and 95th percentile** -  use as 'low (representative)' and 'high (representative)' 
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_r_2mm.3in))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats_rep <- rep(subsurf_stats$value, subsurf_stats$acres)
  subsurf_stats_rep |>  quantile(probs = c(0.05, 0.95), na.rm = TRUE)
...
#### **Subsurface frag high percent (3 in. +)**
...
EDIT_updates_filtered$subsurf_frags_r_gt_3in <- ifelse(is.na(EDIT_updates_filtered$subsurf_frags_r_gt_3in), 0, EDIT_updates_filtered$subsurf_frags_r_gt_3in)
...
subsurf_frags_small.df <-
  EDIT_updates_filtered |>  select(coiid, subsurf_frags_r_gt_3in, subsurf_frags_lo_gt_3in,
                                   subsurf_frags_hi_gt_3in, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "frag_small",
    values_to = "value",
    cols = c("subsurf_frags_r_gt_3in", "subsurf_frags_lo_gt_3in", "subsurf_frags_hi_gt_3in")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_hi_gt_3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_lo_gt_3in, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Subsurface frags high (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$subsurf_frags_lo_gt_3in, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$subsurf_frags_hi_gt_3in, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_hi_gt_3in, na.rm = TRUE) &
             min(EDIT_updates_filtered$subsurf_frags_hi_gt_3in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_hi_gt_3in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$subsurf_frags_hi_gt_3in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_hi_gt_3in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
**Subsurface frags high (3 in.+) acreage weighted 95th percentile**
...
**Subsurface frags high (3 in.+) percentage acreage weighted summary statistics**
```{r}
...
#### **Subsurface frag low percent (3 in. +)**
...
subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_lo_gt_3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_lo_gt_3in, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Subsurface frags low (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_lo_gt_3in, na.rm = TRUE) &
  ...
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_lo_gt_3in, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$subsurf_frags_lo_gt_3in, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_lo_gt_3in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
**Subsurface frags low (3 in.+) acreage weighted 5th percentile**
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_lo_gt_3in))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats <- subsurf_frags_small.df |>  dplyr::filter(frag_small == "subsurf_frags_lo_gt_3in" & ! is.na(value))
  subsurf_stats_rep <- rep(subsurf_stats$value, subsurf_stats$acres)
  subsurf_stats_rep |>  quantile(probs = c(0.05), na.rm = TRUE)
...
**Subsurface frags low (3 in.+) percentage acreage weighted summary statistics**
```{r}
...
#### **Subsurface frag RV percent (3 in. +)**
...
subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_r_gt_3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  ...
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Subsurface frags RV (3 inches +)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_r_gt_3in, na.rm = TRUE) &
             min(EDIT_updates_filtered$subsurf_frags_r_gt_3in, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_gt_3in, na.rm = TRUE), round_by, f = floor) - bin_width,
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_r_gt_3in") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
