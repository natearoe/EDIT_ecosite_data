...
surf_frag.df <-
  EDIT_updates_filtered |>  select(coiid, frags_r_2mm_3in_on_surf, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "surf_frag",
    values_to = "value",
    cols = c("frags_r_2mm_3in_on_surf")) |> 
  dplyr::rename(acres = comp_acres)
...
surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_r_2mm_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_r_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$frags_r_2mm_3in_on_surf, na.rm = TRUE), round_by, f = floor),
...
surf_frag.df <-
  EDIT_updates_filtered |>  select(coiid, frags_r_gt_3in_on_surf, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "surf_frag",
    values_to = "value",
    cols = c("frags_r_gt_3in_on_surf")) |> 
  dplyr::rename(acres = comp_acres)
...
surf_frag1 <- ggplot(surf_frag.df |>  filter(surf_frag == "frags_r_gt_3in_on_surf"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$frags_r_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$frags_r_gt_3in_on_surf, na.rm = TRUE), round_by, f = floor),
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv))) {print("No data populated in NASIS for this field.")
...
subsurf_frags_small.df <-
  EDIT_updates_filtered |>  select(coiid, subsurf_frags_r_2mm.3in_rv, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "frag_small",
    values_to = "value",
    cols = c("subsurf_frags_r_2mm.3in_rv")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_r_2mm.3in_rv"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE) &
             min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_r_2mm.3in_rv") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_r_2mm.3in_rv))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats <- subsurf_frags_small.df |>  dplyr::filter(frag_small == "subsurf_frags_r_2mm.3in_rv" & ! is.na(value))
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv))) {print("No data populated in NASIS for this field.")
...
subsurf_frags_small.df <-
  EDIT_updates_filtered |>  select(coiid, subsurf_frags_r_gt_3in_rv, comp_acres) |> 
  tidyr::pivot_longer(
    names_to = "frag_small",
    values_to = "value",
    cols = c("subsurf_frags_r_gt_3in_rv")) |> 
  dplyr::rename(acres = comp_acres)

# Create component histogram

subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df |>  filter(frag_small == "subsurf_frags_r_gt_3in_rv"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE), round_by, f = ceiling), bin_width)

my_seq <- if(min(my_seq) == min(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE) &
             min(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE) - bin_width >= 0){
  seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE), round_by, f = floor) - bin_width,
      round_any(max(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv, na.rm = TRUE), round_by, f = ceiling), bin_width)
} else{
  my_seq            
}
...
for(i in names(my_seq)){
  ...
  if(i == 0){
      ...
      my_list[[i]] <- subsurf_frags.df.acres |>  filter(frag_small == "subsurf_frags_r_gt_3in_rv") |>  filter(value >= as.numeric(i) & value <= as.numeric(i) + bin_width)
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_r_gt_3in_rv))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats <- subsurf_frags_small.df |>  dplyr::filter(frag_small == "subsurf_frags_r_gt_3in_rv" & ! is.na(value))
  subsurf_stats_rep <- rep(subsurf_stats$value, subsurf_stats$acres)
  subsurf_stats_rep |>  quantile(probs = c(0.05, 0.25, 0.75, 0.95), na.rm = TRUE)
