...
el_h1 <- ggplot(elev.df %>% filter(elev == "elev_h_ft"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$elev_l_ft), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Elevation (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Elevation (ft.)") +
  scale_x_continuous(limits = c(round_any(min(EDIT_updates_filtered$elev_l_ft), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$elev_h_ft), round_by, f = ceiling)),
  n.breaks = length(seq(round_any(min(EDIT_updates_filtered$elev_l_ft), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$elev_h_ft), round_by, f = ceiling), round_by)))
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$elev_l_ft), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$elev_h_ft), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
expand_elev_h <- elev_h_acres_prepped[rep(1:nrow(elev_h_acres_prepped), times = elev_h_acres_prepped$acres), c("range", "elev", "coiids"), drop = FALSE]
...
el_h2 <- ggplot(expand_elev_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Elevation (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of acres") + xlab("Elevation (ft.)") +
  scale_x_continuous(limits = c(round_any(min(EDIT_updates_filtered$elev_l_ft), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$elev_h_ft), round_by, f = ceiling)),
  n.breaks = length(seq(round_any(min(EDIT_updates_filtered$elev_l_ft), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$elev_h_ft), round_by, f = ceiling), round_by)))
...
if (all(is.na(EDIT_updates_filtered$elev_h_ft))) {print("No data populated in NASIS for this field.")
  ...
  rep(EDIT_updates_filtered$elev_h_ft, EDIT_updates_filtered$comp_acres) %>% quantile(probs = c(0.95))
...
expand_elev_l <- elev_l_acres_prepped[rep(1:nrow(elev_l_acres_prepped), times = elev_l_acres_prepped$acres), c("range", "elev", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$elev_l_ft))) {print("No data populated in NASIS for this field.")
  ...
  elev_l_stats_rep %>% quantile(probs = c(0.05))
...
if (all(is.na(EDIT_updates_filtered$elev_l_ft))) {print("No data populated in NASIS for this field.")
  ...
  elev_h_stats <- elev.df %>% dplyr::filter(elev == "elev_h_ft")
...
expand_elev_r <- elev_r_acres_prepped[rep(1:nrow(elev_r_acres_prepped), times = elev_r_acres_prepped$acres), c("range", "elev", "coiids"), drop = FALSE]
...
slope_h1 <- ggplot(slope.df %>% filter(slope == "slope_h"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$slope_l), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("Slope (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("Slope (ft.)") +
  scale_x_continuous(limits = c(round_any(min(EDIT_updates_filtered$slope_l), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$slope_h), round_by, f = ceiling)),
  n.breaks = length(seq(round_any(min(EDIT_updates_filtered$slope_l), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$slope_h), round_by, f = ceiling), round_by)))
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$slope_l), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$slope_h), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
expand_slope_h <- slope_h_acres_prepped[rep(1:nrow(slope_h_acres_prepped), times = slope_h_acres_prepped$acres), c("range", "slope", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$slope_h))) {print("No data populated in NASIS for this field.")
  ...
  slope_h_stats_rep %>% quantile(probs = c(0.95))
...
expand_slope_l <- slope_l_acres_prepped[rep(1:nrow(slope_l_acres_prepped), times = slope_l_acres_prepped$acres), c("range", "slope", "coiids"), drop = FALSE]
...
expand_slope_r <- slope_r_acres_prepped[rep(1:nrow(slope_r_acres_prepped), times = slope_r_acres_prepped$acres), c("range", "slope", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$slope_r))) {print("No data populated in NASIS for this field.")
  ...
  slope_r_stats_rep %>% quantile(probs = c(0.05, 0.95))
...
expand_water_table_h <- water_table_h_acres_prepped[rep(1:nrow(water_table_h_acres_prepped), times = water_table_h_acres_prepped$acres), c("range", "water_table", "coiids"), drop = FALSE]
...
water_table_h2 <- ggplot(expand_water_table_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Water table (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of acres") + xlab("Water table (inches)") +
  scale_x_continuous(limits = c(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = ceiling)),
  n.breaks = length(seq(round_any(min(EDIT_updates_filtered$water_table_l_in, na.rm = TRUE), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$water_table_h_in, na.rm = TRUE), round_by, f = ceiling), round_by)))
...
expand_water_table <- water_table_l_acres_prepped[rep(1:nrow(water_table_l_acres_prepped), times = water_table_l_acres_prepped$acres), c("range", "water_table", "coiids"), drop = FALSE]
...
expand_restriction_h <- restriction_h_acres_prepped[rep(1:nrow(restriction_h_acres_prepped), times = restriction_h_acres_prepped$acres), c("range", "restriction", "coiids"), drop = FALSE]
...
restriction_h2 <- ggplot(expand_restriction_h, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Restriction depth (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of acres") + xlab("Restriction depth (in.)") +
  scale_x_continuous(limits = c(0, 90),
  breaks = seq(0, 90, 5))
...
expand_restriction_l <- restriction_l_acres_prepped[rep(1:nrow(restriction_l_acres_prepped), times = restriction_l_acres_prepped$acres), c("range", "restriction", "coiids"), drop = FALSE]
...
expand_restriction_r <- restriction_r_acres_prepped[rep(1:nrow(restriction_r_acres_prepped), times = restriction_r_acres_prepped$acres), c("range", "restriction", "coiids"), drop = FALSE]
...
surf_frag1 <- ggplot(surf_frag.df %>% filter(surf_frag == "surfhzn_frags_r_2mm.3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
expand_surf_frag <- surf_frag_r_acres_prepped[rep(1:nrow(surf_frag_r_acres_prepped), times = surf_frag_r_acres_prepped$acres), c("range", "surf_frag", "coiids"), drop = FALSE]
...
surf_frag2 <- ggplot(expand_surf_frag, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  ylab("# of acres") + xlab("Surface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
if (all(is.na(EDIT_updates_filtered$surfhzn_frags_r_2mm.3in))) {print("No data populated in NASIS for this field.")
  ...
  surf_frag_h_stats_rep %>% quantile(probs = c(0.05, 0.25, 0.75, 0.95))
...
surf_frag1 <- ggplot(surf_frag.df %>% filter(surf_frag == "surfhzn_frags_r_gt_3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$surfhzn_frags_r_gt_3in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$surfhzn_frags_r_gt_3in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$surfhzn_frags_r_gt_3in), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
awc_h1 <- ggplot(awc_h.df %>% filter(awc == "awc_h_0_40_in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$awc_l_0_40_in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("AWC 0-40inches (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("AWC") +
  scale_x_continuous(limits = c(round_any(min(EDIT_updates_filtered$awc_l_0_40_in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$awc_h_0_40_in), round_by, f = ceiling)),
  n.breaks = length(seq(round_any(min(EDIT_updates_filtered$awc_l_0_40_in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$awc_h_0_40_in), round_by, f = ceiling), round_by)))
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$awc_l_0_40_in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$awc_h_0_40_in), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
expand_awc_h <- awc_h_acres_prepped[rep(1:nrow(awc_h_acres_prepped), times = awc_h_acres_prepped$acres), c("range", "awc", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$awc_h_0_40_in))) {print("No data populated in NASIS for this field.")
  ...
  awc_h_stats_rep %>% quantile(probs = c(0.95))
...
expand_awc_l <- awc_l_acres_prepped[rep(1:nrow(awc_l_acres_prepped), times = awc_l_acres_prepped$acres), c("range", "awc", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$awc_l_0_40_in))) {print("No data populated in NASIS for this field.")
  ...
  awc_l_stats_rep %>% quantile(probs = c(0.05))
...
expand_awc_r <- awc_r_acres_prepped[rep(1:nrow(awc_r_acres_prepped), times = awc_r_acres_prepped$acres), c("range", "awc", "coiids"), drop = FALSE]

# Create acreage histogram

awc_r2 <- ggplot(expand_awc_r, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$awc_r_0_40_in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
if (all(is.na(EDIT_updates_filtered$awc_r_0_40_in))) {print("No data populated in NASIS for this field.")
  ...
  awc_r_stats_rep %>% quantile(probs = c(0.05, 0.95))
...
ph_h1 <- ggplot(ph_h.df %>% filter(ph == "pH_h_0_10in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$pH_l_0_10in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
  ggtitle("pH 0-10 inches (high)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of components") + xlab("pH") +
  scale_x_continuous(limits = c(round_any(min(EDIT_updates_filtered$pH_l_0_10in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$pH_h_0_10in), round_by, f = ceiling)),
  n.breaks = length(seq(round_any(min(EDIT_updates_filtered$pH_l_0_10in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$pH_h_0_10in), round_by, f = ceiling), round_by)))
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$pH_l_0_10in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$pH_h_0_10in), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
expand_ph_h <- ph_h_acres_prepped[rep(1:nrow(ph_h_acres_prepped), times = ph_h_acres_prepped$acres), c("range", "ph", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$pH_h_0_10in))) {print("No data populated in NASIS for this field.")
  ...
  ph_h_stats_rep %>% quantile(probs = c(0.95))
...
expand_ph_l <- ph_l_acres_prepped[rep(1:nrow(ph_l_acres_prepped), times = ph_l_acres_prepped$acres), c("range", "ph", "coiids"), drop = FALSE]
...
if (all(is.na(EDIT_updates_filtered$pH_l_0_10in))) {print("No data populated in NASIS for this field.")
  ...
  ph_l_stats_rep %>% quantile(probs = c(0.05))
...
if (all(is.na(EDIT_updates_filtered$pH_l_0_10in))) {print("No data populated in NASIS for this field.")
  ...
  quantile(c(ph_l_stats_rep, ph_h_stats_rep), probs = c(0.25, 0.75))
...
subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df %>% filter(frag_small == "subsurf_frags_r_2mm.3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_2mm.3in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$subsurf_frags_r_2mm.3in), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
...
expand_subsurf_frags_r <- subsurf_frags_r_acres_prepped[rep(1:nrow(subsurf_frags_r_acres_prepped), times = subsurf_frags_r_acres_prepped$acres), c("range", "frag_small", "coiids"), drop = FALSE]
...
subsurf_frags_small_r2 <- ggplot(expand_subsurf_frags_r, aes(x = range)) + geom_histogram(aes(text = paste("coiid(s):", stringr::str_wrap(coiids, 40))),  
  ...
  #theme_minimal() + 
  ggtitle("Subsurface frags (2mm - 3 inches)") + theme(plot.title = element_text(hjust = 0.5)) +
  ylab("# of acres") + xlab("Subsurface frags (%)") +
  scale_x_continuous(limits = c(0, 100),
  breaks = seq(0,100, 10))
...
if (all(is.na(EDIT_updates_filtered$subsurf_frags_r_2mm.3in))) {print("No data populated in NASIS for this field.")
  ...
  subsurf_stats_rep %>% quantile(probs = c(0.05, 0.25, 0.75, 0.95))
...
subsurf_frags_small_r1 <- ggplot(subsurf_frags_small.df %>% filter(frag_small == "subsurf_frags_r_gt_3in"), aes(x = value)) + geom_histogram(aes(text = paste("coiid(s):", coiid)), 
  binwidth = bin_width,
  center = round_any(min(EDIT_updates_filtered$subsurf_frags_r_gt_3in), round_by, f = floor) + bin_width/2,
  color = "black",
  fill = "grey") + 
  #theme_minimal() + 
...
my_list <- list()
my_seq <- seq(round_any(min(EDIT_updates_filtered$subsurf_frags_r_gt_3in), round_by, f = floor),
  round_any(max(EDIT_updates_filtered$subsurf_frags_r_gt_3in), round_by, f = ceiling), bin_width)
names(my_seq) <- my_seq
