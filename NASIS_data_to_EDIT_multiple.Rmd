...
EDIT_updates <- read.csv("C:/Users/Nathan.Roe/Documents/SEKI/EDIT_ecosite_data-main/EDIT_ecosite_data-main/ecosite_report.csv")
```
...
acreage_unit <- ifelse(min(elev_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
               ifelse(min(elev_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(elev_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(elev_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(elev_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(elev_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(slope_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(slope_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(slope_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(slope_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(slope_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(slope_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(pond_depth_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(pond_depth_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(pond_depth_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(pond_depth_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
pond_depth_rv_acres$numb_coiids <- sapply(pond_depth_rv_acres$coiids, FUN = function(x){
  ...
  acreage_unit <- ifelse(min(pond_depth_rv_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                         ifelse(min(pond_depth_rv_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(water_table_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(water_table_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(water_table_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(water_table_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(aspect_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(aspect_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(map_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(map_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(map_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(map_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(map_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(map_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(ffd_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(ffd_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(ffd_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(ffd_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(ffd_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(ffd_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(restriction_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(restriction_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(restriction_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(restriction_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(restriction_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(restriction_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(surf_frag_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(surf_frag_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(awc_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(awc_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(awc_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(awc_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(awc_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(awc_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(ph_h_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(ph_h_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(ph_l_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(ph_l_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
...
acreage_unit <- ifelse(min(subsurf_frags_r_acres_prepped$acres, na.rm = TRUE) < 100, 10, 
                       ifelse(min(subsurf_frags_r_acres_prepped$acres, na.rm = TRUE) < 1000, 100, 1000))
