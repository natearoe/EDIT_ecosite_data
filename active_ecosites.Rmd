...
```{r}
NASIS_report <- read.csv("C:/Users/Nathan.Roe/Documents/PES4ever/NASIS_ecosite_to_EDIT/EDIT_ecosite_data/ecosite_report.csv")
```
...
```{r}
multiple_MLRAs <- ecosite_df$Ecosite[c(str_which(ecosite_df$Ecosite, "(?<=R|F{1})018"), str_which(ecosite_df$Ecosite, "(?<=R|F{1})018"))]
```
